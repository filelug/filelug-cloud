...
import org.clopuccino.domain.RequestFindBookmarkByIdModel;
...
/**
 * <code>FindBookmarkByIdServlet</code>
 *
 * @author masonhsieh
 * @version 1.0
 */
@WebServlet(name = "find-bookmark-by-id", displayName = "find-bookmark-by-id", description = "find bookmark by id", urlPatterns = {"/bookmarks/find"})
public class FindBookmarkByIdServlet extends HttpServlet {

    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(FindBookmarkByIdServlet.class.getSimpleName());

    private static final long serialVersionUID = -1124641232934933579L;
    ...
    public FindBookmarkByIdServlet() {
        super();
        ...
        try {
            ...
            if (socket != null && socket.validate(true)) {
                ...
                if (bookmarkIdNode == null) {
                    ...
                    RequestFindBookmarkByIdModel requestModel = new RequestFindBookmarkByIdModel(Sid.FIND_BOOKMARK_BY_ID, userId, bookmarkId, clientLocale);
            ...
            LOGGER.error("Error on finding bookmark by id.", e);
