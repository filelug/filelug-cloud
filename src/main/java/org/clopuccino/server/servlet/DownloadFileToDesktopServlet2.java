...
/**
 * <code>DownloadFileServlet2</code> does not count down CloseLatch when file is transfered to the desktop successfully.
 *
 * @author masonhsieh
 * @version 1.0
 */
@WebServlet(name = "download-file-to-desktop2", asyncSupported = true, displayName = "download-file-to-desktop2", description = "Download file to desktop(V2)", urlPatterns = {"/directory/sdownload2"})
public class DownloadFileToDesktopServlet2 extends HttpServlet {

    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(DownloadFileToDesktopServlet2.class.getSimpleName());

    private static final long serialVersionUID = -223112589422094270L;
    ...
    public DownloadFileToDesktopServlet2() {
        super();
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        final String transferKey = req.getHeader(Constants.HTTP_HEADER_AUTHORIZATION_NAME);
