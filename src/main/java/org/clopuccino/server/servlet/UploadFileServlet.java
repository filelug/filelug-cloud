...
/**
 * <code>UploadFileServlet</code> is the service for desktop to upload file to server.
 *
 * @author masonhsieh
 * @version 1.0
 */
@WebServlet(name = "upload-file-from-desktop", displayName = "upload-file-from-desktop", description = "Upload file from desktop", urlPatterns = {"/directory/supload"})
public class UploadFileServlet extends HttpServlet {

    private static final Logger LOGGER = (Logger) LoggerFactory.getLogger(String.valueOf(Sid.DOWNLOAD_FILE));

    private static final long serialVersionUID = 4683494931680934640L;
